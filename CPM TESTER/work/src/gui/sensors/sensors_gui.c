...
static SElExceptionPtr DisplayTree(const char* fileXml, const char* GUID)
{
	...
	short int		AXvalue;
	int				i, j, k, l, m ,n ,length, length2;
	...
	for( i=0; i<length; i++)
	{
		...
		if (plist2) CA_DiscardObjHandle(plist2);
	...
	/* PV1 outputs */
	EXCCHECKMSXML( MSXML_IXMLDOMNodeselectNodes (pnode, NULL, "task[@type='PV1']", &plist));
	EXCCHECKMSXML( MSXML_IXMLDOMNodeListGetlength (plist, NULL, &length));
	EXCCHECKMSXML( MSXML_IXMLDOMNodeListreset (plist, NULL));
	...
	/* PV2 outputs */
	EXCCHECKMSXML( MSXML_IXMLDOMNodeselectNodes (pnode, NULL, "task[@type='PV2']", &plist));
	EXCCHECKMSXML( MSXML_IXMLDOMNodeListGetlength (plist, NULL, &length));
	EXCCHECKMSXML( MSXML_IXMLDOMNodeListreset (plist, NULL));
	...
	/* PV3 outputs */
	EXCCHECKMSXML( MSXML_IXMLDOMNodeselectNodes (pnode, NULL, "task[@type='PV3']", &plist));
	EXCCHECKMSXML( MSXML_IXMLDOMNodeListGetlength (plist, NULL, &length));
	EXCCHECKMSXML( MSXML_IXMLDOMNodeListreset (plist, NULL));
