...
static SElExceptionPtr traca_Get_BoardVer_sFin_Active(STracaPtr me, char *board_Ver_sFin, int* id_board_sFin, bool_t *active);
...
static SElExceptionPtr traca_Get_FieldLabel(STracaPtr me, int id_board_pFin, int* count, char *FieldName, char *FieldData);
static SElExceptionPtr traca_Get_Last_Mouvement(STracaPtr me, char *Num_Serie, int* id_board, char *TypeTest, bool_t *result);
