...
static SElExceptionPtr traca_Get_Id_Test_Produit(STracaPtr me, char *Num_Serie_pFin,  char *Date_Debut, int* Id_Test_Produit);
static SElExceptionPtr traca_Set_Measurement(STracaPtr me, int Id_Test_Produit, char *Nom_Mesure ,float Low_Limit, float High_Limit, float Mesure,bool_t Result);
...
)
{
	...
	pnew_traca->Get_Id_Test_Produit			= traca_Get_Id_Test_Produit;
	pnew_traca->Set_Measurement				= traca_Set_Measurement;	
	if (traca)
		*traca = pnew_traca;
...
)
{
	...
	me->_Get_Id_Test_ProduitSpec			= (SElExceptionPtr (*)(STracaPtr, char * , char *, int * ))
													GetProcAddress(me->specLib, "Get_Id_Test_Produit");	

	me->_Set_MeasurementSpec				= (SElExceptionPtr (*)(STracaPtr, int , char *, float , float , float , bool_t ))
													GetProcAddress(me->specLib, "Set_Measurement");	
...
Error:
	...
	if (pexception)
	{
		...
		me->_Get_Id_Test_ProduitSpec	= NULL;			
		me->_Set_MeasurementSpec	= NULL;			
	}
...
#undef __FUNC__
#define __FUNC__ "{Traca}::traca_Get_Id_Test_Produit"
static SElExceptionPtr traca_Get_Id_Test_Produit(STracaPtr me, char *Num_Serie_pFin,  char *Date_Debut, int* Id_Test_Produit)
{
	SElExceptionPtr	pexception = NULL;
	

	if (me->_Get_Id_Test_ProduitSpec)
		EXCCHECK( me->_Get_Id_Test_ProduitSpec(me, Num_Serie_pFin, Date_Debut ,Id_Test_Produit));
...
#undef __FUNC__
#define __FUNC__ "{Traca}::traca_Set_Measurement"
static SElExceptionPtr traca_Set_Measurement(STracaPtr me, int Id_Test_Produit, char *Nom_Mesure ,float Low_Limit, float High_Limit, float Mesure,bool_t Result)
{
	SElExceptionPtr	pexception = NULL;

	
	if (me->_Set_MeasurementSpec)
		EXCCHECK( me->_Set_MeasurementSpec(me, Id_Test_Produit, Nom_Mesure, Low_Limit, High_Limit,Mesure,Result));
