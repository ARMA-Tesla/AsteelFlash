...
)
{
	...
	me->Set_MeasurementSpec				= (SElExceptionPtr (*)(STracaPtr, int *, char *, float , float , float , bool_t*))
...
static SElExceptionPtr traca_Set_Measurement(STracaPtr me, int Id_Test_Produit, char *Nom_Mesure ,char *Low_Limit, char *High_Limit, char *Mesure,bool_t Result)
{
	SElExceptionPtr	pexception = NULL;
