...
/*- 64-bit VISA Types --------------------------------------------------------------*/
/*- These should be removed once the appropriate visa.h and vpptype.h are shipped   */
/*- with ICP                                                                        */
...
#if (defined(_MSC_VER) && (_MSC_VER >= 1200)) || (defined(__BORLANDC__) && (__BORLANDC__ >= 0x0520) || (defined(_CVI_) && (_CVI_>= 700)))
...
/* Useful constants                                                 ======== */
/*****************************************************************************/
#define IVI_ENGINE_MAJOR_VERSION        3
