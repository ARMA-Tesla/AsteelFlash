/*
 *  "elErrWin.c" - Windows (Win32) error handling routines.
 *
 *	(c) 2007 ELCOM, a.s.
 *		All Rights Reserved.
 *
...
#if 1
static char _ident[] = "@(#) elErrWin.c 0.1 2007-03-05";
#else
#endif
...
ERROR_OPERATION_ABORTED,			"OPERATION_ABORTED",			/* 995 */
ERROR_IO_PENDING,					"IO_PENDING",					/* 997 */
...
ERROR_EXE_MACHINE_TYPE_MISMATCH,	"EXE_MACHINE_TYPE_MISMATCH",
...
ERROR_DIFFERENT_SERVICE_ACCOUNT,	"DIFFERENT_SERVICE_ACCOUNT",
#endif	/* -- } -- */
...
ERROR_SET_POWER_STATE_VETOED,		"SET_POWER_STATE_VETOED",
ERROR_SET_POWER_STATE_FAILED,		"SET_POWER_STATE_FAILED",
ERROR_TOO_MANY_LINKS,				"TOO_MANY_LINKS",
ERROR_OLD_WIN_VERSION,				"OLD_WIN_VERSION",
ERROR_APP_WRONG_OS,					"APP_WRONG_OS",
ERROR_SINGLE_INSTANCE_APP,			"SINGLE_INSTANCE_APP",
ERROR_RMODE_APP,					"RMODE_APP",
ERROR_INVALID_DLL,					"INVALID_DLL",
...
ERROR_NOT_LOGGED_ON,				"NOT_LOGGED_ON",
ERROR_CONTINUE,						"CONTINUE",
ERROR_ALREADY_INITIALIZED,			"ALREADY_INITIALIZED",
ERROR_NO_MORE_DEVICES,				"NO_MORE_DEVICES",
...
ERROR_LICENSE_QUOTA_EXCEEDED,		"LICENSE_QUOTA_EXCEEDED",
...
ERROR_NO_SYSTEM_RESOURCES,			"NO_SYSTEM_RESOURCES",
ERROR_NONPAGED_SYSTEM_RESOURCES,	"NONPAGED_SYSTEM_RESOURCES",
ERROR_PAGED_SYSTEM_RESOURCES,		"PAGED_SYSTEM_RESOURCES",
ERROR_WORKING_SET_QUOTA,			"WORKING_SET_QUOTA",
ERROR_PAGEFILE_QUOTA,				"PAGEFILE_QUOTA",
ERROR_COMMITMENT_LIMIT,				"COMMITMENT_LIMIT",
ERROR_MENU_ITEM_NOT_FOUND,			"MENU_ITEM_NOT_FOUND",
ERROR_INVALID_KEYBOARD_HANDLE,		"INVALID_KEYBOARD_HANDLE",
ERROR_HOOK_TYPE_NOT_ALLOWED,		"HOOK_TYPE_NOT_ALLOWED",
ERROR_REQUIRES_INTERACTIVE_WINDOWSTATION,	"REQUIRES_INTERACTIVE_WINDOWSTATION",
...
ERROR_NO_BROWSER_SERVERS_FOUND,		"NO_BROWSER_SERVERS_FOUND",
...
ERROR_INVALID_PRINT_MONITOR,		"INVALID_PRINT_MONITOR",
ERROR_PRINT_MONITOR_IN_USE,			"PRINT_MONITOR_IN_USE",
ERROR_PRINTER_HAS_JOBS_QUEUED,		"PRINTER_HAS_JOBS_QUEUED",
ERROR_SUCCESS_REBOOT_REQUIRED,		"SUCCESS_REBOOT_REQUIRED",
ERROR_SUCCESS_RESTART_REQUIRED,		"SUCCESS_RESTART_REQUIRED",
...
RPC_S_INVALID_STRING_BINDING,		"INVALID_STRING_BINDING",
RPC_S_WRONG_KIND_OF_BINDING,		"WRONG_KIND_OF_BINDING",
RPC_S_INVALID_BINDING,				"INVALID_BINDING",
RPC_S_PROTSEQ_NOT_SUPPORTED,		"PROTSEQ_NOT_SUPPORTED",
RPC_S_INVALID_RPC_PROTSEQ,			"INVALID_RPC_PROTSEQ",
RPC_S_INVALID_STRING_UUID,			"INVALID_STRING_UUID",
RPC_S_INVALID_ENDPOINT_FORMAT,		"INVALID_ENDPOINT_FORMAT",
RPC_S_INVALID_NET_ADDR,				"INVALID_NET_ADDR",
RPC_S_NO_ENDPOINT_FOUND,			"NO_ENDPOINT_FOUND",
RPC_S_INVALID_TIMEOUT,				"INVALID_TIMEOUT",
RPC_S_OBJECT_NOT_FOUND,				"OBJECT_NOT_FOUND",
RPC_S_ALREADY_REGISTERED,			"ALREADY_REGISTERED",
RPC_S_TYPE_ALREADY_REGISTERED,		"TYPE_ALREADY_REGISTERED",
RPC_S_ALREADY_LISTENING,			"ALREADY_LISTENING",
RPC_S_NO_PROTSEQS_REGISTERED,		"NO_PROTSEQS_REGISTERED",
RPC_S_NOT_LISTENING,				"NOT_LISTENING",
RPC_S_UNKNOWN_MGR_TYPE,				"UNKNOWN_MGR_TYPE",
RPC_S_UNKNOWN_IF,					"UNKNOWN_IF",
RPC_S_NO_BINDINGS,					"NO_BINDINGS",
RPC_S_NO_PROTSEQS,					"NO_PROTSEQS",
RPC_S_CANT_CREATE_ENDPOINT,			"CANT_CREATE_ENDPOINT",
RPC_S_OUT_OF_RESOURCES,				"OUT_OF_RESOURCES",
RPC_S_SERVER_UNAVAILABLE,			"SERVER_UNAVAILABLE",
RPC_S_SERVER_TOO_BUSY,				"SERVER_TOO_BUSY",
RPC_S_INVALID_NETWORK_OPTIONS,		"INVALID_NETWORK_OPTIONS",
RPC_S_NO_CALL_ACTIVE,				"NO_CALL_ACTIVE",
RPC_S_CALL_FAILED,					"CALL_FAILED",
RPC_S_CALL_FAILED_DNE,				"CALL_FAILED_DNE",
RPC_S_PROTOCOL_ERROR,				"PROTOCOL_ERROR",
RPC_S_UNSUPPORTED_TRANS_SYN,		"UNSUPPORTED_TRANS_SYN",
RPC_S_UNSUPPORTED_TYPE,				"UNSUPPORTED_TYPE",
RPC_S_INVALID_TAG,					"INVALID_TAG",
RPC_S_INVALID_BOUND,				"INVALID_BOUND",
RPC_S_NO_ENTRY_NAME,				"NO_ENTRY_NAME",
RPC_S_INVALID_NAME_SYNTAX,			"INVALID_NAME_SYNTAX",
RPC_S_UNSUPPORTED_NAME_SYNTAX,		"UNSUPPORTED_NAME_SYNTAX",
RPC_S_UUID_NO_ADDRESS,				"UUID_NO_ADDRESS",
RPC_S_DUPLICATE_ENDPOINT,			"DUPLICATE_ENDPOINT",
RPC_S_UNKNOWN_AUTHN_TYPE,			"UNKNOWN_AUTHN_TYPE",
RPC_S_MAX_CALLS_TOO_SMALL,			"MAX_CALLS_TOO_SMALL",
RPC_S_STRING_TOO_LONG,				"STRING_TOO_LONG",
RPC_S_PROTSEQ_NOT_FOUND,			"PROTSEQ_NOT_FOUND",
RPC_S_PROCNUM_OUT_OF_RANGE,			"PROCNUM_OUT_OF_RANGE",
RPC_S_BINDING_HAS_NO_AUTH,			"BINDING_HAS_NO_AUTH",
RPC_S_UNKNOWN_AUTHN_SERVICE,		"UNKNOWN_AUTHN_SERVICE",
RPC_S_UNKNOWN_AUTHN_LEVEL,			"UNKNOWN_AUTHN_LEVEL",
RPC_S_INVALID_AUTH_IDENTITY,		"INVALID_AUTH_IDENTITY",
RPC_S_UNKNOWN_AUTHZ_SERVICE,		"UNKNOWN_AUTHZ_SERVICE",

RPC_S_NOTHING_TO_EXPORT,			"NOTHING_TO_EXPORT",
RPC_S_INCOMPLETE_NAME,				"INCOMPLETE_NAME",
RPC_S_INVALID_VERS_OPTION,			"INVALID_VERS_OPTION",
RPC_S_NO_MORE_MEMBERS,				"NO_MORE_MEMBERS",
RPC_S_NOT_ALL_OBJS_UNEXPORTED,		"NOT_ALL_OBJS_UNEXPORTED",
RPC_S_INTERFACE_NOT_FOUND,			"INTERFACE_NOT_FOUND",
RPC_S_ENTRY_ALREADY_EXISTS,			"ENTRY_ALREADY_EXISTS",
RPC_S_ENTRY_NOT_FOUND,				"ENTRY_NOT_FOUND",
RPC_S_NAME_SERVICE_UNAVAILABLE,		"NAME_SERVICE_UNAVAILABLE",
RPC_S_INVALID_NAF_ID,				"INVALID_NAF_ID",
RPC_S_CANNOT_SUPPORT,				"CANNOT_SUPPORT",
RPC_S_NO_CONTEXT_AVAILABLE,			"NO_CONTEXT_AVAILABLE",
RPC_S_INTERNAL_ERROR,				"INTERNAL_ERROR",
RPC_S_ZERO_DIVIDE,					"ZERO_DIVIDE",
RPC_S_ADDRESS_ERROR,				"ADDRESS_ERROR",
RPC_S_FP_DIV_ZERO,					"FP_DIV_ZERO",
RPC_S_FP_UNDERFLOW,					"FP_UNDERFLOW",
RPC_S_FP_OVERFLOW,					"FP_OVERFLOW",

RPC_S_CALL_IN_PROGRESS,				"CALL_IN_PROGRESS",
RPC_S_NO_MORE_BINDINGS,				"NO_MORE_BINDINGS",
RPC_S_NO_INTERFACES,				"NO_INTERFACES",
RPC_S_CALL_CANCELLED,				"CALL_CANCELLED",
RPC_S_BINDING_INCOMPLETE,			"BINDING_INCOMPLETE",
RPC_S_COMM_FAILURE,					"COMM_FAILURE",
RPC_S_UNSUPPORTED_AUTHN_LEVEL,		"UNSUPPORTED_AUTHN_LEVEL",
RPC_S_NO_PRINC_NAME,				"NO_PRINC_NAME",
RPC_S_NOT_RPC_ERROR,				"NOT_RPC_ERROR",
RPC_S_UUID_LOCAL_ONLY,				"UUID_LOCAL_ONLY",
RPC_S_SEC_PKG_ERROR,				"SEC_PKG_ERROR",
RPC_S_NOT_CANCELLED,				"NOT_CANCELLED",

RPC_S_GROUP_MEMBER_NOT_FOUND,		"GROUP_MEMBER_NOT_FOUND",
RPC_S_INVALID_OBJECT,				"INVALID_OBJECT",
RPC_S_SEND_INCOMPLETE,				"SEND_INCOMPLETE",


-1,	"RPC_X_",

RPC_X_NO_MORE_ENTRIES,				"NO_MORE_ENTRIES",
RPC_X_SS_CHAR_TRANS_OPEN_FAIL,		"SS_CHAR_TRANS_OPEN_FAIL",
RPC_X_SS_CHAR_TRANS_SHORT_FILE,		"SS_CHAR_TRANS_SHORT_FILE",
RPC_X_SS_IN_NULL_CONTEXT,			"SS_IN_NULL_CONTEXT",
RPC_X_SS_CONTEXT_DAMAGED,			"SS_CONTEXT_DAMAGED",
RPC_X_SS_HANDLES_MISMATCH,			"SS_HANDLES_MISMATCH",
RPC_X_SS_CANNOT_GET_CALL_HANDLE,	"SS_CANNOT_GET_CALL_HANDLE",
RPC_X_NULL_REF_POINTER,				"NULL_REF_POINTER",
RPC_X_ENUM_VALUE_OUT_OF_RANGE,		"ENUM_VALUE_OUT_OF_RANGE",
RPC_X_BYTE_COUNT_TOO_SMALL,			"BYTE_COUNT_TOO_SMALL",
RPC_X_BAD_STUB_DATA,				"BAD_STUB_DATA",
RPC_X_INVALID_ES_ACTION,			"INVALID_ES_ACTION",
RPC_X_WRONG_ES_VERSION,				"WRONG_ES_VERSION",
RPC_X_WRONG_STUB_VERSION,			"WRONG_STUB_VERSION",
RPC_X_INVALID_PIPE_OBJECT,			"INVALID_PIPE_OBJECT",
RPC_X_INVALID_PIPE_OPERATION,		"INVALID_PIPE_OPERATION",
RPC_X_WRONG_PIPE_VERSION,			"WRONG_PIPE_VERSION",


-1,	"EPT_S_",

EPT_S_INVALID_ENTRY,				"INVALID_ENTRY",
EPT_S_CANT_PERFORM_OP,				"CANT_PERFORM_OP",
EPT_S_NOT_REGISTERED,				"NOT_REGISTERED",
EPT_S_CANT_CREATE,					"CANT_CREATE",


-1,	"OR_",

OR_INVALID_OXID,					"INVALID_OXID",
OR_INVALID_OID,						"INVALID_OID",
OR_INVALID_SET,						"INVALID_SET",

#endif	/* -- } -- */
};
#define WIN_ERRORs	EL_ARRAY_CNT(gs_win_error)
...
/******************************************************************************/
#undef	__FUNC__
#define	__FUNC__	"elErrWinStartup"
...
/******************************************************************************/
#undef	__FUNC__
#define	__FUNC__	"elErrWinCleanup"
 ...
 * 'elErrWinHasStr()':
 *
 * Zjistí, zda-li má daný chybový kód (typu 'GetLastError()') definovan øetìzec,
 * který jej popisuje.
 */
#undef  __FUNC__
#define __FUNC__	"elErrWinHasStr"
EL_DLL_API bool elErrWinHasStr(DWORD errnum)
{
	register int i;

	for(i = 0; i < WIN_ERRORs && gs_win_error[i].num != errnum; i++)
		;
	return (bool) (i < WIN_ERRORs ? TRUE : FALSE);
}
 ...
 * 'elErrWinSymStr()':
 *
 * Vrací symbolické (zkrácené) oznaèení ("ERROR_..." / "NERR_..." / "RPC_..." /
 * / ...) pro danou chybu typu 'GetLastError()' v prostøedí WIN32 API.
 */
#undef  __FUNC__
#define __FUNC__	"elErrWinSymStr"
EL_DLL_API TCHAR *elErrWinSymStr(DWORD errnum)
{
#define ERR_STR_LEN_MAX		64
	elStr_t			*errsym;
#if defined(UNICODE)
	wchar_t			ustr[WIN_ERR_SYM_MAXLEN+ST];
#endif
	register TCHAR	*prefix;
	register int	i;

	errsym = elStrTmpIdxGet(EL_STR_IDX_ERR_WIN1);
	...
	for(i = 0, prefix = _T(""); i < WIN_ERRORs; i++)
	{
		if ( gs_win_error[i].num == errnum )
		{
#if defined(UNICODE)
#pragma message("elErrWinSymStr(): UNICODE version not implemented yet")
			_tcscpy(errsym,prefix);
			elStrAnsi2Unicode(gs_win_error[i].str,ustr);
			_tcscat(errsym,ustr);
#else
			errsym->Printf(errsym,_T("%s%s"),prefix,gs_win_error[i].str);
#endif
			return errsym->ptr;
		}
		if ( gs_win_error[i].num == -1 )
		{
#if defined(UNICODE)
			ansi2unicode_str(gs_win_error[i].str,ustr);
			prefix = ustr;
#else
			prefix = gs_win_error[i].str;
#endif
		}
	}

#if 1
	errsym->Printf(errsym,_T("ERROR_%lu"),errnum);
	return errsym->ptr;
#else
	return _T("ERROR_\?\?\?");
#endif
 ...
 * 'elErrWinSymNum()':
 *
 * Vrací hodnotu chyby typu 'GetLastError()' (WIN32 API) pro dané symbolické
 * (zkrácené) oznaèení ("ERROR_..." / ...) chyby typu 'GetLastError()'
 * (WIN32 API) (opak 'elErrWinSymStr()').
 */
#undef  __FUNC__
#define __FUNC__	"elErrWinSymNum"
EL_DLL_API DWORD elErrWinSymNum(TCHAR *errsym)
{
	...
	for(i=0, prefix = _T(""), plen=0; i<WIN_ERRORs; i++)
	{
#if defined(UNICODE)
#pragma message("elErrWinSymNum(): UNICODE version not implemented yet")
		ansi2unicode_str(gs_win_error[i].str,ustr);
#endif
		if ( gs_win_error[i].num == -1 )
		{
...
#else
			plen = (int) _tcslen(prefix = gs_win_error[i].str);
#endif
			continue;
		}
		/*
		 * Symbolické oznaèení mùže být s nebo bez prefixu
		 * ("ERROR_FILE_NOT_FOUND" nebo "FILE_NOT_FOUND"):
		 */
#if defined(UNICODE)
...
#else
		if ( !_tcscmp(gs_win_error[i].str,errsym) ||
			!_tcsncmp(prefix,errsym,plen) &&
			!_tcscmp(gs_win_error[i].str,errsym+plen) )
#endif
			return gs_win_error[i].num;
	}
	return (DWORD)-1;
}
 ...
 * 'elErrWinStr()':
 *
 * Vrací øetìzec popisující danou chybu typu 'GetLastError()'
 * v prostøedí WIN32 API.
 */
#undef  __FUNC__
#define __FUNC__	"elErrWinStr"
...
#define ERR_STR_LEN_MAX		256
	...
	errstr = elStrTmpIdxGet(EL_STR_IDX_ERR_WIN2);
	...
	if ( !len )
	{
		...
		/*
		 * Pro zobrazení chyby funkce 'FormatMessage()' použijeme místo
		 * 'Log("%M")' alespoò 'WinErrSymStr()', abychom se nevolali rekurzivnì
		 * ("%M" => 'WinErrStr()'):
		 */
		error = GetLastError();
		elLog(_T("%s(): FormatMessage(%lu): %s <%lu>"),_T(__FUNC__),errnum,
			elErrWinSymStr(error),error);
		/*
		 * A vrátíme taktéž alespoò symbolické oznaèení pùvodní chyby:
		 */
		errstr->Printf(errstr,_T("<%s/%ld>"),elErrWinSymStr(errnum),errnum);
	}
	else
	{
		/*
		 * Chybové zprávy WIN32 API vrácené funkcí 'FormatMessage()' konèí
		 * teèkou a navíc mezerou ("Chybová zpráva. "). Zøejmì kvùli tomu, že
		 * se vìtšinou používají pro 'MessageBox()' ve kterém to pak lépe vypadá
		 * a nebo se pøedpokládá pøípadná další vìta za touto zprávou.
		 */
		if ( errstr->ptr[len-1] == _T(' ') && errstr->ptr[len-2] == _T('.') )
			len -= 2, errstr->ptr[len] = _T('\0');

		errstr->PrintfAt(errstr,len,
			_T(" <%s/%ld>"),elErrWinSymStr(errnum),errnum);
	}
...
/******************************************************************************/
/*
 * 'elErrGetLastErrorStr()':
 *
 * Vrací øetìzec popisující poslední chybu pøi volání funkce WIN32 API.
 */
#undef  __FUNC__
#define __FUNC__	"elErrGetLastErrorStr"
EL_DLL_API TCHAR *elErrGetLastErrorStr(void)
{
	return elErrWinStr(GetLastError());
}

/******************************************************************************/
/*
 * 'elErrGetLastErrorText()': Viz. 'GetLastErrorStr()'.
 */
#undef  __FUNC__
#define __FUNC__	"elErrGetLastErrorText"
EL_DLL_API TCHAR *elErrGetLastErrorText(void)
{
	return elErrGetLastErrorStr();
}
