/*****************************************************************************
 *  Resistor Class Driver                               
 *  Original Release: 11. dubna 2007                                  
 *  By: Zdenek Rykala, ELCOM, a.s.                              
 *      PH. +420 558 279 916   Fax +420 558 279 901                              
 *                                                                           
 *  Modification History:                                                    
 *                                                                           
 *       11. dubna 2007 - Class Driver Created.                  
 *                                                                           
 *****************************************************************************/
 ...
 *  Global Definitions
 ****************************************************************************/
#define CLASS_NAME      "Resistor"

static  IviStringValueTable ClassErrorMessagesTable = 
    {
    RESISTOR_ERROR_CODES_AND_MSGS,
    {VI_NULL, VI_NULL}
    };
...
/****************************************************************************
 *  Resistor Function Names, Tables, and Typedefs
 ****************************************************************************/
enum
    {
	kConfigureOutputResistance = kNumInherentFunctions,
	kCalibrateOutputResistance,
	kReadCalibration,
	kWriteCalibration,
	kWriteInstrData,
	kReadInstrData,
...
static IviStringValueTable funcTable =
    {
    INHERENT_FUNCTION_TABLE(Resistor),
	{kConfigureOutputResistance,		"Resistor_ConfigureOutputResistance"},		
	{kCalibrateOutputResistance,		"Resistor_CalibrateOutputResistance"},		
	{kReadCalibration,		"Resistor_ReadCalibration"},		
	{kWriteCalibration,		"Resistor_WriteCalibration"},		
	{kWriteInstrData,		"Resistor_WriteInstrData"},		
	{kReadInstrData,		"Resistor_ReadInstrData"},		
    {VI_NULL, VI_NULL}
    };

/*- Function Pointer Typedefs -*/
typedef ViStatus (_VI_FUNC *ConfigureOutputResistanceFuncPtr) (ViSession vi,
                                                      ViChar _VI_FAR channelName[],
                                                      ViReal64 resistance);

typedef ViStatus (_VI_FUNC *CalibrateOutputResistanceFuncPtr) (ViSession vi,
                                                      ViChar _VI_FAR channelName[],
                                                      ViReal64 outputResistance,
                                                      ViInt32 calibrationType);

typedef ViStatus (_VI_FUNC *ReadCalibrationFuncPtr) (ViSession vi,
                                            ViChar _VI_FAR channelName[]);

typedef ViStatus (_VI_FUNC *WriteCalibrationFuncPtr) (ViSession vi,
                                             ViChar _VI_FAR channelName[]);

typedef ViStatus (_VI_FUNC *WriteInstrDataFuncPtr) (ViSession vi,
                                           ViChar _VI_FAR writeBuffer[]);

typedef ViStatus (_VI_FUNC *ReadInstrDataFuncPtr) (ViSession vi,
...
#define RESISTOR_SIMULATE_BEGIN(f)        IVI_SIMULATE_BEGIN(f, Resistor, RESISTOR)
                               ...
                               ViSession* newSession)
{
    ...
    RESISTOR_SIMULATE_BEGIN(InitSimStatus)
    SIMULATE_END()
...
/**************************************************************************** 
 *  Function: Resistor_InitWithOptions                                     
 *  Purpose:  Open an instrument session, queries the instrument ID, and      
 *            initializes the instrument to a known state.                    
 ****************************************************************************/
 ...
 ****************************************************************************/
ViStatus _VI_FUNC Resistor_self_test (ViSession vi, ViInt16* testResult, ViChar testMessage[])
{
    DECLARE(self_test)
    ...
    RESISTOR_SIMULATE_BEGIN(self_test)
 ...
 ****************************************************************************/
ViStatus _VI_FUNC Resistor_error_query (ViSession vi, ViInt32 *errorCode, ViChar errorMessage[])
{
    DECLARE(error_query)
    ...
    RESISTOR_SIMULATE_BEGIN(error_query)
...
/**************************************************************************** 
 *  Function: Resistor_error_message                                        
 *  Purpose:  Translate the error return value from the instrument into a     
 *            user-readable string.                                           
 ****************************************************************************/
ViStatus _VI_FUNC Resistor_error_message (ViSession vi, ViStatus statusCode, ViChar message[])
{
    DECLARE_NO_SPECIFIC_CALL()
    ...
    if (vi)
        {
        RESISTOR_SIMULATE_BEGIN(error_message)
...
/**************************************************************************** 
 *  Function: Resistor_revision_query                                       
 ...
 ****************************************************************************/
ViStatus _VI_FUNC Resistor_revision_query (ViSession vi, ViChar driverRev[], ViChar instrRev[])
{
    ...
    RESISTOR_SIMULATE_BEGIN(revision_query)
...
/****************************************************************************
 *  Function: Resistor_InvalidateAllAttributes
...
ViStatus _VI_FUNC Resistor_InvalidateAllAttributes (ViSession vi)
{
    ...
    RESISTOR_SIMULATE_BEGIN(InvalidateAllAttributes)
    SIMULATE_END()
...
/*****************************************************************************
 * Function: Resistor_ResetWithDefaults
...
ViStatus _VI_FUNC Resistor_ResetWithDefaults (ViSession vi)
{
    ...
    RESISTOR_SIMULATE_BEGIN(ResetWithDefaults)
    SIMULATE_END()
...
ViStatus _VI_FUNC Resistor_Disable (ViSession vi)
{
    ...
    RESISTOR_SIMULATE_BEGIN(Disable)
    SIMULATE_END()
...
ViStatus _VI_FUNC Resistor_CheckAttributeViString (ViSession vi, ViConstString channelName, ViAttr attributeId, ViConstString value)
{
...
ViStatus _VI_FUNC Resistor_CheckAttributeViBoolean (ViSession vi, ViConstString channelName, ViAttr attributeId, ViBoolean value)
{
...
ViStatus _VI_FUNC Resistor_CheckAttributeViSession (ViSession vi, ViConstString channelName, ViAttr attributeId, ViSession value)
{
 ...
 *            session.                                                        
 ****************************************************************************/
ViStatus  _VI_FUNC Resistor_GetErrorInfo (ViSession vi, 
                                          ViStatus *primaryError, 
                                          ViStatus *secondaryError, 
 ...
 *            session.                                                        
 ****************************************************************************/
ViStatus  _VI_FUNC Resistor_ClearErrorInfo (ViSession vi)
{
 ...
 ****************************************************************************/
ViStatus _VI_FUNC Resistor_GetSpecificDriverIUnknownPtr (ViSession vi, void* ref)
{
 ...
 ****************************************************************************/
/****************************************************************************
 *  Function: Resistor_ConfigureOutputResistance
 *  Purpose: 
 ****************************************************************************/
ViStatus _VI_FUNC Resistor_ConfigureOutputResistance (ViSession vi,
                                                      ...
                                                      ViReal64 resistance)
{
	DECLARE(ConfigureOutputResistance)

	LOCK()

	SPECIFIC_CALL_BEGIN(ConfigureOutputResistance)
		SPECIFIC_CALL_ARG(channelName)
		SPECIFIC_CALL_ARG(resistance)
	SPECIFIC_CALL_END()

	RESISTOR_SIMULATE_BEGIN(ConfigureOutputResistance)
		SIMULATE_ARG(channelName)
		SIMULATE_ARG(resistance)
...
/****************************************************************************
 *  Function: Resistor_CalibrateOutputResistance
 *  Purpose: 
 ****************************************************************************/
ViStatus _VI_FUNC Resistor_CalibrateOutputResistance (ViSession vi,
                                                      ...
                                                      ViInt32 calibrationType)
{
	DECLARE(CalibrateOutputResistance)

	LOCK()

	SPECIFIC_CALL_BEGIN(CalibrateOutputResistance)
		SPECIFIC_CALL_ARG(channelName)
		SPECIFIC_CALL_ARG(outputResistance)
		SPECIFIC_CALL_ARG(calibrationType)
	SPECIFIC_CALL_END()

	RESISTOR_SIMULATE_BEGIN(CalibrateOutputResistance)
		SIMULATE_ARG(channelName)
		SIMULATE_ARG(outputResistance)
		SIMULATE_ARG(calibrationType)
...
/****************************************************************************
 *  Function: Resistor_ReadCalibration
 *  Purpose: 
 ****************************************************************************/
ViStatus _VI_FUNC Resistor_ReadCalibration (ViSession vi,
                                            ViChar _VI_FAR channelName[])
{
	DECLARE(ReadCalibration)

	LOCK()

	SPECIFIC_CALL_BEGIN(ReadCalibration)
		SPECIFIC_CALL_ARG(channelName)
	SPECIFIC_CALL_END()

	RESISTOR_SIMULATE_BEGIN(ReadCalibration)
		SIMULATE_ARG(channelName)
...
/****************************************************************************
 *  Function: Resistor_WriteCalibration
 *  Purpose: 
 ****************************************************************************/
ViStatus _VI_FUNC Resistor_WriteCalibration (ViSession vi,
                                             ViChar _VI_FAR channelName[])
{
	DECLARE(WriteCalibration)

	LOCK()

	SPECIFIC_CALL_BEGIN(WriteCalibration)
		SPECIFIC_CALL_ARG(channelName)
	SPECIFIC_CALL_END()

	RESISTOR_SIMULATE_BEGIN(WriteCalibration)
		SIMULATE_ARG(channelName)
...
/****************************************************************************
 *  Function: Resistor_WriteInstrData
 *  Purpose: 
 ****************************************************************************/
ViStatus _VI_FUNC Resistor_WriteInstrData (ViSession vi,
                                           ViChar _VI_FAR writeBuffer[])
{
	DECLARE(WriteInstrData)

	LOCK()

	SPECIFIC_CALL_BEGIN(WriteInstrData)
		SPECIFIC_CALL_ARG(writeBuffer)
	SPECIFIC_CALL_END()

	RESISTOR_SIMULATE_BEGIN(WriteInstrData)
		SIMULATE_ARG(writeBuffer)
...
/****************************************************************************
 *  Function: Resistor_ReadInstrData
 *  Purpose: 
 ****************************************************************************/
ViStatus _VI_FUNC Resistor_ReadInstrData (ViSession vi,
                                          ...
                                          ViPInt32 numBytesRead)
{
	DECLARE(ReadInstrData)

	LOCK()

	SPECIFIC_CALL_BEGIN(ReadInstrData)
		SPECIFIC_CALL_ARG(number_ofBytesToRead)
		SPECIFIC_CALL_ARG(readBuffer)
		SPECIFIC_CALL_ARG(numBytesRead)
	SPECIFIC_CALL_END()

	RESISTOR_SIMULATE_BEGIN(ReadInstrData)
		SIMULATE_ARG(number_ofBytesToRead)
		SIMULATE_ARG(readBuffer)
		SIMULATE_ARG(numBytesRead)
...
/***************************************************************************** 
 *  Function: ResistorClassRevision_ReadCallback                                
 *  Purpose:  Read callback for RESISTOR_ATTR_CLASS_REVISION          
 *****************************************************************************/
static ViStatus _VI_FUNC ClassRevision_ReadCallback (ViSession vi, 
                                                     ViSession io, 
                                                     ViConstString channelName, 
                                                     ...
                                                     const ViConstString value)
{
    ...
    ClassUtil_BuildRevision(newValue, 
                  CLASS_NAME, 
                  RESISTOR_MAJOR_VERSION, 
                  RESISTOR_MINOR_VERSION);
    checkErr( Ivi_SetValInStringCallback (vi, attributeId, newValue));
Error:
    return error;
}
...
static ViStatus InitAttributes (ViSession vi)
{
    ...
    checkErr( Ivi_SetAttrReadCallbackViString (vi, RESISTOR_ATTR_FUNCTION_CAPABILITIES,
                                               FuncCapabilities_ReadCallback));
    
    checkErr( Ivi_SetAttributeViInt32 (vi, VI_NULL,
                                       IVI_ATTR_CLASS_DRIVER_MAJOR_VERSION, 
                                       0, RESISTOR_MAJOR_VERSION));
    checkErr( Ivi_SetAttributeViInt32 (vi, VI_NULL,
                                       IVI_ATTR_CLASS_DRIVER_MINOR_VERSION, 
                                       0, RESISTOR_MINOR_VERSION));
    checkErr( Ivi_SetAttributeViString (vi, VI_NULL, 
                                       RESISTOR_ATTR_CLASS_DRIVER_VENDOR, 
                                       0, RESISTOR_DRIVER_VENDOR));
    checkErr( Ivi_SetAttributeViString (vi, VI_NULL, 
                                       RESISTOR_ATTR_CLASS_DRIVER_DESCRIPTION, 
                                       0, RESISTOR_DRIVER_DESCRIPTION));
    checkErr( Ivi_SetAttrReadCallbackViString (vi, RESISTOR_ATTR_CLASS_DRIVER_REVISION, 
